...
export default function JobItemContent() {
  ...
  const {jobItem, isFetching, error} = useJobItem(activeId)
      ...
      <div>
        ...
        <footer className="job-details__footer">
          <p className="job-details__footer-text">
            If possible, please reference that you found the job on. We would
